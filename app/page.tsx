      ...
      <main className="flex-grow">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <p className="text-lg text-[var(--accent)] mb-8">
                  Connect with licensed veterinarians 24/7 for expert pet care advice, consultations, and peace of mind.
                </p>
                <a 
        ...
        <section className="py-24 bg-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 className="text-3xl font-bold text-center mb-12 text-[var(--text-primary)]">Our Services</h2>
        ...
        <section className="py-24 bg-[var(--accent)]">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 className="text-3xl font-bold text-center mb-12 text-[var(--text-primary)]">How It Works</h2>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {[
                {
                  step: "1",
        ...
        <section className="py-16 bg-gradient-to-br from-[var(--secondary)] to-[var(--secondary-light)]">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            {/* Review Carousel */}
            <div className="mt-16">
              <h3 className="text-xl font-semibold text-white text-center mb-8">What Our Pet Parents Say</h3>
              <ReviewCarousel />
            </div>
          </div>
        </section>
        ...
        <section className="py-24 bg-[var(--primary)]">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p className="text-xl text-[var(--accent)] mb-8">Book your first consultation today and give your pet the care they deserve.</p>
            <a 
              href="https://wa.me/5571991916499" 
              target="_blank" 
              rel="noopener noreferrer" 
