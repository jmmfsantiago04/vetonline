...
const services = [
  {
    ...
    description: "Face-to-face virtual appointments with experienced veterinarians for comprehensive pet care guidance.",
    price: "R$120",
    duration: "30 minutes",
    features: [
  ...
  },
  {
    id: 2,
    name: "Chat Support",
    description: "Instant messaging with veterinary professionals for quick questions and ongoing pet care support.",
    price: "R$60",
  ...
  },
  {
    ...
    description: "Priority access to veterinarians for urgent pet health concerns and immediate guidance.",
    price: "R$180",
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              ...
              <p className="text-lg text-[var(--accent)] max-w-2xl mx-auto">
                Professional pet care from the comfort of your home. Choose the service that best fits your needs.
              </p>
            </div>
          </div>
        </section>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {services.map((service) => (
                <div key={service.id} className="bg-white rounded-2xl shadow-lg overflow-hidden">
                  ...
                  <div className="p-6">
                    <h3 className="text-2xl font-semibold text-[var(--text-primary)] mb-2">{service.name}</h3>
                    ...
                    <div className="flex justify-between items-center mb-4">
                      ...
                      <span className="text-sm text-[var(--text-secondary)]">{service.duration}</span>
                    </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              {commonConditions.map((item, index) => (
                <div key={index} className="bg-white rounded-xl p-6 shadow-lg">
                  <h3 className="text-xl font-semibold text-[var(--primary)] mb-4">{item.category}</h3>
        ...
        <section className="py-16 bg-gradient-to-br from-[var(--secondary)] to-[var(--secondary-light)] text-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p className="text-lg text-[var(--accent)] mb-8 max-w-2xl mx-auto">
              Choose the service that best fits your needs and book your consultation today. Our veterinarians are here to help!
            </p>
            <Link
              href="https://wa.me/5571991916499"
              target="_blank"
